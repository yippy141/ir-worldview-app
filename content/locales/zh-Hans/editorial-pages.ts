  ...
  sections: [
    {
      ...
      title: "如何使用",
      paragraphs: [
        "先完成基础问卷，逐项复核答案；再根据需要使用议题专题或情境推演，查看具体议题和角色处境是否改变你的基线。世界观资料和方法页说明模型纳入了哪些传统、证据覆盖到哪里，以及哪些部分仍有缺口。",
      ],
      actions: [
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          heading: "专题叠加是编辑转换，不是重新测量基础画像",
          body: "专题结果来自专题问题，用于说明读者在该议题中的判断。它不会从头重测七个基础维度。专题叠加只是改变基础空间中的相对重点，不会用更精确的测量取代基础结果。",
        },
      ],
    },
    {
