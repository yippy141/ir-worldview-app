...
export const EVIDENCE_BANK_SPECS: readonly EvidenceBankSpec[] = [
  ...
  {
    key: "security-bank-v5",
    generation: "current",
    instrument: "security",
    bankVersion: 5,
    scoringVersion: 2,
    runtimeVersion: 2,
    sourcePath: "content/instrument/security.v5.json",
    bankVersionField: "instrumentVersion",
    modeStrategy: "declared",
  ...
  {
    key: "security-bank-v4",
    generation: "legacy",
    instrument: "security",
    bankVersion: 4,
    scoringVersion: 2,
    runtimeVersion: 2,
    sourcePath: "content/instrument/security.v4.json",
    bankVersionField: "instrumentVersion",
    modeStrategy: "declared",
    scoringStrategy: "module",
    axes: SECURITY_AXES,
  ...
  },
  {
    ...
    modeNote:
      "Frozen bank-v3/scorer-v2 module bank retained for replay compatibility.",
  },
  {
