...
import type { Claim, Provenance } from "@/lib/decision-exercises/evidence"
import { readEpisode, type ReadbackRelation } from "@/lib/decision-exercises/readbacks"
...
export const draftEpisodes: Record<EpisodeId, Episode> = {
  verify: {
    ...
    sources: [
      ...
      { id: "ai-verification-bank", title: "AI Governance: multilateralVerification", publisher: "IR Worldview Inventory", publishedAt: null, accessedAt: "2026-09-06", url: "/ai/field-guide", kind: "internal-editorial", claimIds: ["verify-mechanism"], locator: "AI Governance bank 3: multilateralVerification; AI Atlas: live disagreements", scope: "Existing editorial contrast between verifiable commitments, participation and domestic enforcement. All actors, timing, sanctions and technical reach above are fictional assumptions." },
    ],
  ...
  access: {
    ...
    question: "How should Larch provide access for this model release?",
    options: [
    ...
    sources: [
      ...
      { id: "ai-access-bank", title: "AI Governance: openWeights", publisher: "IR Worldview Inventory", publishedAt: null, accessedAt: "2026-09-06", url: "/ai/field-guide", kind: "internal-editorial", claimIds: ["access-mechanism"], locator: "AI Governance bank 3: openWeights; Technology bank 3: open_weight_models", scope: "Existing alternatives include containment, instrumented outside access and diffusion. No bank answer or score is assigned here." },
    ],
...
export function episodeProvenance(episode: Episode): Provenance {
  return { instrument: "episode", bank: "unscored", scorer: "none", form: `${episode.id}/two-decisions-v${episode.version}`, copy: episode.version, source: `lib/decision-exercises/${episode.status === "published" ? "catalog" : "content"}.ts` }
}
