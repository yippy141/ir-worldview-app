...
/**
 * Immutable V21 Security instrument: item bank v2, scorer v1.
 *
 ...
 */
export const SECURITY_V21_BANK_VERSION = 2
export const SECURITY_V21_SCORING_VERSION = 1
...
export const securityV21Module: ModuleDefinition = {
  slug: "security",
  shortTitle: "Security",
