/**
 * V22 module scoring runtime.
 *
 * This file owns the current weighting, aggregation, and result assembly used
 * by bank-v3/scorer-v2 module payloads.
 */
import type {
  ModuleAnalytics,
  ModuleAnswers,
...
export const MODULE_SCORING_VERSION = 2
...
export function buildModuleResult(
  ...
  const classificationContext = { mode }
  const interpretation = moduleDefinition.interpret(
    analytics,
