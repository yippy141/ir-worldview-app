...
export const descriptorRationales = {
  ...
  "constitutional-delegation": {
    ...
    "personalExit": ["unspecified", "unresolved", "The scenario does not say whether people have a usable right to leave."],
    "pluralPolities": ["unspecified", "unresolved", "The scenario does not say whether several communities govern themselves."],
    "sharedBenefits": ["variant-dependent", "unresolved", "The authored arrangement permits different settlements of whether everyone receives a guaranteed material floor; none is guaranteed across variants."],
    "privateOwnership": ["variant-dependent", "unresolved", "The authored arrangement permits different settlements of whether private ownership organizes productive resources; none is guaranteed across variants."],
    "biologicalContinuity": ["present", "added-hypothesis", "The authored society retains humans as citizens and decision-makers."],
    "voluntaryTransformation": ["unspecified", "unresolved", "The scenario does not say whether feasible substantial transformation is legally permitted."],
    "digitalStanding": ["unspecified", "unresolved", "The scenario does not say whether artificial persons have institutional standing."],
    "capabilityLimits": ["variant-dependent", "unresolved", "The authored arrangement permits different settlements of whether institutions enforce a ceiling on selected capabilities; none is guaranteed across variants."],
  ...
  "human-machine-federation": {
    "humanAuthority": ["variant-dependent", "unresolved", "The authored arrangement permits different settlements of whether humans retain practical final governing authority; none is guaranteed across variants."],
    "revisablePower": ["variant-dependent", "unresolved", "The authored arrangement permits different settlements of whether people can effectively replace governing mandates; none is guaranteed across variants."],
    ...
    "voluntaryTransformation": ["variant-dependent", "unresolved", "The authored arrangement permits different settlements of whether feasible substantial transformation is legally permitted; none is guaranteed across variants."],
    ...
    "technicalIndependence": ["variant-dependent", "unresolved", "The authored arrangement permits different settlements of whether communities can operate without an indispensable technical provider; none is guaranteed across variants."]
  },
  "compute-oligarchy": {
    "humanAuthority": ["variant-dependent", "unresolved", "The authored arrangement permits different settlements of whether humans retain practical final governing authority; none is guaranteed across variants."],
    "revisablePower": ["variant-dependent", "unresolved", "The authored arrangement permits different settlements of whether people can effectively replace governing mandates; none is guaranteed across variants."],
  ...
  "negotiated-ceiling": {
    ...
    "personalExit": ["unspecified", "unresolved", "The scenario does not say whether people have a usable right to leave."],
    "pluralPolities": ["variant-dependent", "unresolved", "The authored arrangement permits different settlements of whether several communities govern themselves; none is guaranteed across variants."],
    "sharedBenefits": ["unspecified", "unresolved", "The scenario does not say whether everyone receives a guaranteed material floor."],
    "privateOwnership": ["variant-dependent", "unresolved", "The authored arrangement permits different settlements of whether private ownership organizes productive resources; none is guaranteed across variants."],
