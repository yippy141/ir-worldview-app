...
export function CurrentCaseChallengeGate({
  ...
  return (
    <section className={styles.recoveryPanel} aria-labelledby="challenge-recovery-heading">
      ...
      <p>
        This legacy link may contain an encrypted judgment from another reader. V19 does not read,
        validate, or reveal it. You can still complete the same case and compare judgments directly.
      </p>
