...
const fixtures: FoundationFixture[] = [
  {
    ...
    expected: {
      ...
      familyScores: {
        realist: 24.53,
        institutionalist: -19.92,
        constructivist: -14.8,
        criticalPoliticalEconomy: 2.05,
      },
      nearestFitGap: 22.48,
  ...
  },
  {
    ...
    expected: {
      ...
      familyScores: {
        realist: -11.07,
        institutionalist: 17.25,
        constructivist: -3.38,
        criticalPoliticalEconomy: -3.39,
      },
      nearestFitGap: 20.63,
  ...
  },
  {
    ...
    expected: {
      ...
      familyScores: {
        realist: -8.08,
        institutionalist: 1.92,
        constructivist: 16.09,
        criticalPoliticalEconomy: -5.54,
      },
      nearestFitGap: 14.17,
  ...
  },
  {
    ...
    expected: {
      ...
      familyScores: {
        realist: 4.96,
        institutionalist: -8.08,
        constructivist: -6.97,
        criticalPoliticalEconomy: 17.33,
      },
      nearestFitGap: 12.37,
  ...
  },
  {
    ...
    expected: {
      ...
      familyScores: {
        realist: 4.84,
        institutionalist: -0.64,
        constructivist: -4.4,
        criticalPoliticalEconomy: -5.88,
      },
      nearestFitGap: 5.48,
